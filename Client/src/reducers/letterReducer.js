import { ADD_IMAGE, UPDATE_IMAGE_DIMENSIONS, UPDATE_IMAGE_POSITION, ADD_TEXT, UPDATE_TEXT_POSITION, UPDATE_TEXT_DIMENSIONS, UPDATE_TEXT_CONTENT, ADD_LINE, UPDATE_LINE_POINTS, DELETE_LINE, UPDATE_LINE_COLOR, UPDATE_LINE_WIDTH, UPDATE_TEXT_FONT_FAMILY, UPDATE_TEXT_FONT_SIZE, DELETE_TEXT, DELETE_IMAGE, SET_INITIAL_STATE } from '../actionTypes'
...
export function reducer (state, action) {
  ...
  switch (action.type) {
    ...
    case ADD_IMAGE: {
      ...
      return state.concat({ type: 'IMAGE', image, id, width, height, x, y,rotation:0 })
    }
